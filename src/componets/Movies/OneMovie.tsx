...
function OneMovie() {
  ...
  return (
    <div>
         <div className={styles.backgroud} style={{ 
            ...
            <div className={styles.content_container}>
              ...
              <div className={styles.buttons}>
                <div className={styles.btn_play}>
                  <img className={styles.icon_play} src="/images/play-icon-black.png" alt="" />
                  <h1 className={styles.title_play}>CONTINUAR</h1>
                </div>
                <img className={styles.btn_add} src="/images/watchlist-icon.svg" alt="" />
                <img className={styles.btn_group} src="/images/group-icon.png" alt="" />
              </div>
            </div>
           </div>
         </div>
